        ...
        try  {
            ...
            if(staff.getsEmail()!=null) {
                ...
                try {
                    ...
                    libraryController.displayAlert("ERROR-Login: " + e.getMessage(), mainPane, mainPane.getCenter());
                }
            }

            }
        catch (SQLException ex){
            libraryController.displayAlert("ERROR-Login: " + ex.getMessage(), mainPane, mainPane.getCenter());
        }
