            ...
            if (borrower.getbPassword().equals(oldPassword.getText())) {
                ...
                if (newPassword1.getText().equals(newPassword2.getText())) {
                    ...
                    try {
                        ...
                        libraryController.displayAlert("Password Updated! Logging Out..", mPane, mPane.getCenter());
...
//                        stage.close();
                        ...
                        libraryController.displayAlert("Update Borrower Account: " + e.getMessage(), mPane, mPane.getCenter());
                    }
                } else {
                    // wrong new password
