...
public class DeleteBorrowerAccountController implements Initializable {
    ...
    public void buildData() {
        try {
            ...
            libraryController.displayAlert("Borrowers List: " + ex.getMessage());
        }
    }
    ...
    public void deleteAccount() {
        try {
            ...
            libraryController.displayAlert("Borrower Account has been Deleted!");
    ...
    public void getAccount() {
        try {
            ...
            libraryController.displayAlert("Find Profile: " + ex.getMessage());
        }
    }
