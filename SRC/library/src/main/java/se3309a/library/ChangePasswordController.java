...
//
//
//    public void setIPayrollController(LibraryController controller) {
...
//            String encryptedPassword = libraryController.encrypt(oldPassword.getText());
...
//                    String encryptedNewPassword = libraryController.encrypt(newPassword1.getText());
//
...
//                        libraryController.displayAlert("Update User Account: " + e.getMessage());
//                    }
//                } else {
//                    // wrong new password
...
//            libraryController.displayAlert("Find User Account: " + ex.getMessage());
//        }
//    }
//
//    public void cancel() {
